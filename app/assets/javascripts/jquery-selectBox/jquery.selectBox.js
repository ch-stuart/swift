...
if(jQuery) (function($) {
	...
	$.extend($.fn, {
		...
		selectBox: function(method, data) {
            ...
            // .bind('scroll.selectBox', hideMenus)
				...
				if( inline ) {
					...
					label
                        ...
                        .css('background-color', getLabelBackgroundColorHex(select));
            ...
            var getLabelBackgroundColorHex = function(select) {
                return $(select).find('OPTION:selected').data('hex');
            };
			...
			var generateOptions = function(originalOptions, options){
				originalOptions.each(function(){
                    ...
                    li.css('background-color', self.data('hex'))
					li.data( self.data() );
